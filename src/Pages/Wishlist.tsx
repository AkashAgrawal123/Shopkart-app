...
const Wishlist = () => {
  ...
  console.log("Wishlist Items:", wishlistItemsArray);

  useEffect(() => {
    console.log("Wishlist component updated");
  }, [wishlistItemsArray]);
                    ...
                    <div className="wishlist__list--item" key={data.id}>
                      <div className="wishlist__list--item-image">
                        <div className="wishlist__list--heart">
                          {data.isLiked ? (
                            <BsSuitHeartFill
                              className="wishlist__list--heart-icon__filled"
                              onClick={() => handleHeartClick(data.id, data)}
                            />
                          ) : (
                            <BsSuitHeart className="wishlist__list--heart-icon" />
                          )}
                        </div>
                      ...
                      <div className="wishlist__list--item-heading">
                        <h3 className="wishlist__list--item-name">
                          {data.name}
                        </h3>
